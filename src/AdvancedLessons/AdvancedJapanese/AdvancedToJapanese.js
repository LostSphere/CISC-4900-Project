...
import "./AdvancedToJapanese.css"; 

function AdvancedToJapanese() {
  ...
  const storageKey = "quizProgress_AdvancedJapanese";
  ...
  const handleQuizAnswer = (selectedOption) => {
    ...
    if (currentQuestionIndex < quizData.length - 1) {
      ...
      localStorage.setItem("quizProgress_AdvancedJapanese", JSON.stringify({ score: updatedScore }));
  
      const highestScore = parseInt(localStorage.getItem("highestScore_AdvancedToJapanese"), 10) || 0;
      if (updatedScore > highestScore) {
        localStorage.setItem("highestScore_AdvancedToJapanese", updatedScore);
      }
    }
  };
...
export default AdvancedToJapanese;
