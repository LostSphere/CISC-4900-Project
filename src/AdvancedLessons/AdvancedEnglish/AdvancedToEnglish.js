...
import "./AdvancedToEnglish.css"; 

function AdvancedToEnglish() {
  ...
  const storageKey = "quizProgress_AdvancedEnglish";
  ...
  const handleQuizAnswer = (selectedOption) => {
    ...
    if (currentQuestionIndex < quizData.length - 1) {
      ...
      localStorage.setItem("quizProgress_AdvancedEnglish", JSON.stringify({ score: updatedScore }));
...
export default AdvancedToEnglish;
