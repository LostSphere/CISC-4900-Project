...
import "./AdvancedToGerman.css";

function AdvancedToGerman() {
  ...
  const storageKey = "quizProgress_AdvancedGerman";
  ...
  const handleQuizAnswer = (selectedOption) => {
    ...
    if (currentQuestionIndex < quizData.length - 1) {
      ...
      localStorage.setItem("quizProgress_AdvancedGerman", JSON.stringify({ score: updatedScore }));
  
      const highestScore = parseInt(localStorage.getItem("highestScore_AdvancedToEnglish"), 10) || 0;
      if (updatedScore > highestScore) {
        localStorage.setItem("highestScore_AdvancedToEnglish", updatedScore);
      }
    }
  };
...
export default AdvancedToGerman;
