...
import storyData from "./JapaneseStoryData.json";
import quizData from "./japaneseQuizData.json";
import "./JapaneseStory.css"; 

function JapaneseStory() {
  ...
  const storageKey = "quizProgress_LostTokyo";
