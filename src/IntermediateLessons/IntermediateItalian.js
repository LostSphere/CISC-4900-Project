...
import "./IntermediateToItalian.css";

function IntermediateToItalian() {
  ...
  const storageKey = "quizProgress_IntermediateItalian";
  ...
  const handleQuizAnswer = (selectedOption) => {
    ...
    if (currentQuestionIndex < quizData.length - 1) {
      ...
      localStorage.setItem("quizProgress_IntermediateItalian", JSON.stringify({ score: updatedScore }));
  
      const highestScore = parseInt(localStorage.getItem("highestScore_IntermediateToItalian"), 10) || 0;
      if (updatedScore > highestScore) {
        localStorage.setItem("highestScore_IntermediateToItalian", updatedScore);
      }
    }
  };
...
export default IntermediateToItalian;
