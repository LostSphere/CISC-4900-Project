...
import "./IntermediateToJapanese.css"; 

function IntermediateToJapanese() {
  ...
  const storageKey = "quizProgress_IntermediateJapanese";
  ...
  const handleQuizAnswer = (selectedOption) => {
    ...
    if (currentQuestionIndex < quizData.length - 1) {
      ...
      localStorage.setItem("quizProgress_IntermediateJapanese", JSON.stringify({ score: updatedScore }));
  
      const highestScore = parseInt(localStorage.getItem("highestScore_IntermediateToJapanese"), 10) || 0;
      if (updatedScore > highestScore) {
        localStorage.setItem("highestScore_IntermediateToJapanese", updatedScore);
      }
    }
  };
...
export default IntermediateToJapanese;
